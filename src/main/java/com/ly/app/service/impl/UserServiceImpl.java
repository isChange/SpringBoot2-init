...
public class UserServiceImpl extends ServiceImpl<UserMapper, User>
    ...
    public Long registerUser(String account, String password, String checkPassword) {
        ...
        String encryptPassword = PasswordUtil.encryptMd5(password,
            DateUtil.parseLocalDateTimeToStr(DateUtil.YYYYMMDDHHMMSS, now));
    ...
    public SafeUserVO loginUser(String account, String password) {
        ...
        // 3. 校验密码
        String encryptPassword = PasswordUtil.encryptMd5(password,
            DateUtil.parseLocalDateTimeToStr(DateUtil.YYYYMMDDHHMMSS, user.getCreateTime()));
        AssertUtil.isTrue(encryptPassword.equals(user.getUserPassword()), UserEnum.USER_LOGIN_FAIL);
